                        ...
                        <table class="table">
                            ...
                            <tr role="row" class="">
                                @foreach($discounts as $discount)
                                    ...
                                    <td><a href="">{{ $discount->percent }}% برای @lang($discount->type)</a></td>
                                    <td>{{$discount->expire_at ? \Morilog\Jalali\Jalalian::fromCarbon($discount->expire_at)->format('Y/m/d H:i') :"بدون تاریخ انقضا"}}</td>
