                ...
                @auth()
                    <div class="user-menu-account">
                        <div class="user-image">
                            <img src="{{auth()->user()->image ? auth()->user()->image->thumb :'/img/avatar.jpg' }}" alt="{{auth()->user()->name}}">
                        </div>
        ...
        <div class="container">
            <ul class="nav">
                ...
                @foreach($categories as $category)
                    <li class="main-menu {{count($category->subCategory) ? 'has-sub':''}}"><a
                            href="{{$category->path()}}">
                            {{$category->title}}</a>
                        @if($category->subCategory)
                                ...
                                <div class="sub-menu">
                                    <div class="container">
                                        ...
                                        <div><a href="{{$category->path()}}">{{$subCate->title}}</a></div>
                                        @endforeach
                                    </div>
                                </div>
